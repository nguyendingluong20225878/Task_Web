  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Worker dashboard placeholder for Task Web." />
            ...
            <div className="rounded-lg border-4 border-black bg-white p-6 shadow-[8px_8px_0_#111827] sm:p-8">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl font-bold text-gray-700">
                    Workspace cho worker sẽ được nối với flow nhận task và submit sau.
                  </p>
                </div>
                <Link
                  href="/console"
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                ...
                <div className="rounded-lg border-4 border-black bg-white p-4">
                  ...
                  <p className="mt-2 font-black text-gray-950">Worker</p>
                </div>
                <div className="rounded-lg border-4 border-black bg-white p-4">
              ...
              <div className="mt-6 rounded-lg border-4 border-black bg-white p-5">
                <h2 className="text-xl font-black text-gray-950">Worker tools</h2>
                <p className="mt-2 font-bold text-gray-700">
                  Placeholder an toàn. Chưa có transaction, MongoDB call, hoặc mock task.
                </p>
              </div>
            </div>
          </section>
